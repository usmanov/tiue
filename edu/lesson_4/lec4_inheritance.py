...
#         self.name = newname
#     def __str__(self):
#         return "creature:"+str(self.name)+":"+str(self.age)
#
# print("\n---- creature tests ----")
# a = Creature(4)
# print(a)
...
# c.speak()
# print(c.get_age())
# #a.speak() # ошибка из-за отсутствия метода speak для класса Creature, #error because there is no speak method for Creature class
#
#
# #################################
# ## Пример наследования
